...
function Input({ type, placeholder, autocomplete, onChange, isDisabled }: IInput) {
  ...
  return (
    <>
      <Title></Title>
      {/* починить border. когда нет ошибки style перекрывает стиль для :focus */}
      {/* исправить цвет disabled placeholder-а */}
